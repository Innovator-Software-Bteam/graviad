...
export function ProfileExportDialog(props: IProfileExportDialogProps) {
    ...
    const [objectExportType, setObjectExportType] = React.useState<TObjectExportType>('profile');
    ...
    const handleExport = () => {
        ...
        const getNode = () => {
            switch (objectExportType) {
                case 'profile':
                    return document.getElementById('profile-detail-for-preview' + id);
                case 'card':
                    return document.getElementById('profile-card-' + id);
                default:
                    return null;
            }
        }
